        ...
        for product in state.order_depths:
            ...
            if product in stable:
                ...
                if market_take:
                    ...
                    ma2 = np.mean(self.data[product+"_RETURNS"][-30:-1])
                    ...
                    reg_range = abs((2.048-ma)/std)
                    
                    signal = ""
                    if abs(z_score) > threshold:
                        if ma2 > 0 and z_score < 0:
                            signal = 'BUY'  # Mean reversion in uptrend
                        elif ma2 < 0 and z_score > 0:
                            signal = 'SELL'  # Mean reversion in downtrend
